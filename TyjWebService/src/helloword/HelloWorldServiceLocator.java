...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements helloword.HelloWorldService {
    ...
    public helloword.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public helloword.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            helloword.HelloWorldSoapBindingStub _stub = new helloword.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (helloword.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                helloword.HelloWorldSoapBindingStub _stub = new helloword.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
